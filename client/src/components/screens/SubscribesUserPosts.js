...
const SubscribesUserPosts = () => {
   ...
   const deletePost = (postid) => {
    ...
    return (
        <div className="SubscribesUserPosts">
            {
                data.map(item=>{
                    return(
                        <div className="card SubscribesUserPosts-card" key={item._id}>
                        <h5>
                            <Link to={item.postedBy._id !== state._id?"/profile/"+item.postedBy._id:
                        "/profile"
